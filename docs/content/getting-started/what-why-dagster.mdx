...
- **Diagnose data quality issues.** Building data quality checks into your pipelines is straightforward, and you can get notified automatically when data quality issues arise.
